...
p map(Set.new([1, 2, 3, 4])) { |value| value + 1 }
p map({a: 1, b: 2, c: 3}) { |key, val| [key, val * 2] }

# > Yes, because those classes include the Enumerable module, which provides the #each_with_object method that I am leveraging for my method.