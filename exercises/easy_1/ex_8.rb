...
def none_2?(collection, &block)
  !any?(collection, &block)
end

p none_2?([1, 3, 5, 6]) { |value| value.even? } == false
p none_2?([1, 3, 5, 7]) { |value| value.even? } == true
p none_2?([2, 4, 6, 8]) { |value| value.odd? } == true
p none_2?([1, 3, 5, 7]) { |value| value % 5 == 0 } == false
p none_2?([1, 3, 5, 7]) { |value| true } == false
p none_2?([1, 3, 5, 7]) { |value| false } == true
p none_2?([]) { |value| true } == true